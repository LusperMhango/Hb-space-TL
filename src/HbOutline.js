...
const HB_text= ()=>{
    return(
        <div
        className='relative justify-center items-center bg-cover bg-center bg-gray-500'
        
        >
        <div className="flex justify-center">
            <div className="text-center p-5">
            <h1 className="font-bold text-red-800 text-3xl mb-8 mt-5 font-serif shadow-lg">WELCOME TO HB SPACE TL</h1>
            ...
            <div className="flex justify-center rounded-lg mt-5">
                 ...
                 <h2 className="pr-80 font-serif text-xl text-blue-800 font-bold">Access</h2>
                 ...
                 <div className="block bg-gray-200  p-5 bg-white rounded-lg shadow-lg text-center font-serif transition-transform duration-300 hover:translate-x-[-20px] mx-5 w-80"> 
                 <h2 className="pr-80 font-serif text-xl text-blue-800 font-bold">Gain</h2>
                 <p className="text-gray-600"> 
                  Develop soft skills and gradually amplify to the next level. Become a Guru with HB space TL</p>
                 </div>
                 <div className="block bg-gray-200  p-5 bg-white rounded-lg shadow-lg text-center font-serif transition-transform duration-300 hover:translate-x-[-20px] mx-5 w-80"> 
                 <h2 className=" pr-80 font-serif text-xl text-blue-800 font-bold">Goal</h2>
                 <p className="text-gray-600"> 
